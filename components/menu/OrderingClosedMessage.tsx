    ...
    <div className="min-h-[60vh] flex items-center justify-center px-5 py-20">
      <div className="max-w-[480px] w-full text-center">
        <div className="bg-white border-2 border-cream-dark rounded-2xl p-10 md:p-12 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
          ...
          <Link
            href="/find-us"
            className="inline-flex items-center justify-center font-semibold text-base tracking-wider uppercase py-4 px-8 rounded-lg bg-red text-white shadow-[0_4px_0_#a01e23,0_6px_20px_rgba(200,39,45,0.25)] hover:opacity-90 transition-opacity"
          >
            View Location
          </Link>
        </div>

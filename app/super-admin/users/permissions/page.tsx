  ...
  return (
    <div className="space-y-10">
      <GovPageHeader
        ...
        subtitle="Declarative Cognito grouping — not a granular RBAC matrix. Middleware protects `/account`, `/admin`, and `/super-admin` unless `COGNITO_PROTECTED_PREFIXES` expands the list."
      />
        ...
        {COGNITO_ROLE_CATALOG.map((role) => (
          ...
          >
            <header className="border-b border-cream-dark/55 px-5 py-4 bg-teal/[0.04]">
              ...
              <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-charcoal/45">
                Cognito group · {role.cognitoGroup}
              </p>
            ...
            <div className="px-5 py-4 flex-1 flex flex-col gap-4">
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-charcoal/45 mb-2">Route prefixes</p>
              ...
              {role.elevated.length > 0 ? (
                ...
                <p className="text-[12px] text-charcoal/55 rounded-xl border border-dashed border-cream-dark px-3 py-2">
                  No supplemental elevated ladders — storefront defaults preserve least privilege.
                </p>
              )}
            </div>
          </article>

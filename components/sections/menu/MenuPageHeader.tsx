    ...
    <header className="sticky top-0 z-[900] bg-cream border-b-[3px] border-gold h-16">
      <div className="max-w-[1200px] mx-auto px-5 h-full flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={onCartClick}
            className="bg-red text-white rounded-lg flex items-center gap-2 py-2 px-4 font-semibold text-sm tracking-wider uppercase shadow-[0_3px_0_#800] hover:-translate-y-0.5 transition-all"
          >
            🛒
            {cartCount > 0 && (

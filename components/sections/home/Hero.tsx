    ...
    >
      ...
      <div className="container max-w-[1140px] mx-auto px-5 relative z-10">
        ...
        >
          ...
          <h1 className="font-display text-[clamp(52px,10vw,110px)] leading-[1.08] text-cream mb-3">
            <span className="block">Big Breakfast.</span>
            <span className="block text-red font-[1000] tracking-[-0.033em] mt-1">Bold Flavor.</span>
